...
import IssueTypeLayout from "../../components/issueType/IssueTypeLayout";
import Login from "../../components/auth/Login";

const setUp = (initialState = {}) => {
        const store = testStore(initialState);
        const wrapper = shallow( < IssueTypeLayout store = {
                store
            }
            history = {
                Login
        ...
        describe("Block tests", () => {
            describe("Checking Prop Types", () => {
                it("It should not throw a warning", () => {
                    ...
                    const propsErr = checkProps(IssueTypeLayout, expectedProps);
            ...
            describe("Rendering component", () => {
                describe("Render with props", () => {
                    ...
                    it("It should render component without errors", () => {
                        const component = findByTestAttribute(wrapper, "IssueTypeLayoutComponent");
